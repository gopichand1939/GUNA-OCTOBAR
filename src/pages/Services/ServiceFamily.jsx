...
export default function ServiceFamily() {
  ...
  const handleViewGallery = () => {
    navigate("/gallery?filter=family");
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row items-center gap-8 sm:gap-12 md:gap-16 relative z-10">
        ...
        >
          ...
          <p className="text-slate-700 text-sm sm:text-base md:text-lg leading-relaxed mb-6 sm:mb-8">
            Celebrate life's special moments with seamless, comfortable, and
            reliable transportation. Whether it's a grand wedding or a cozy
            family get-together, we make sure your guests arrive safely and
            stylishly.
          </p>
          ...
          <ul className="space-y-2 sm:space-y-3 text-slate-600 text-sm sm:text-base md:text-lg">
            <li className="flex items-center gap-2">
              <span className="text-orange-600 text-lg sm:text-xl">✔</span> Wedding Guest Transportation
            </li>
            <li className="flex items-center gap-2">
              <span className="text-orange-600 text-lg sm:text-xl">✔</span> Reception & Ceremony Shuttles
            </li>
            <li className="flex items-center gap-2">
              <span className="text-orange-600 text-lg sm:text-xl">✔</span> Family Reunion Travel
            </li>
            <li className="flex items-center gap-2">
              <span className="text-orange-600 text-lg sm:text-xl">✔</span> Birthday Party Transport
            </li>
            <li className="flex items-center gap-2">
              <span className="text-orange-600 text-lg sm:text-xl">✔</span> Religious Ceremony Services
            </li>
            <li className="flex items-center gap-2">
              <span className="text-orange-600 text-lg sm:text-xl">✔</span> Customizable Routes & Schedules
            </li>
          </ul>
          <motion.button
