...
export default function ServiceCorporate() {
  ...
  const handleViewGallery = () => {
    navigate("/gallery?filter=corporate");
  };
        ...
        >
          ...
          <ul className="space-y-2 sm:space-y-3 text-slate-600 text-sm sm:text-base md:text-lg">
            <li className="flex items-center gap-2">
              <span className="text-orange-600 text-lg sm:text-xl">✔</span> Airport Transfers for Executives
            </li>
            <li className="flex items-center gap-2">
              <span className="text-orange-600 text-lg sm:text-xl">✔</span> Conference & Seminar Transportation
            </li>
            <li className="flex items-center gap-2">
              <span className="text-orange-600 text-lg sm:text-xl">✔</span> Corporate Retreat Packages
            </li>
            <li className="flex items-center gap-2">
              <span className="text-orange-600 text-lg sm:text-xl">✔</span> Executive Chauffeur Services
            </li>
            <li className="flex items-center gap-2">
              <span className="text-orange-600 text-lg sm:text-xl">✔</span> Multi-Day Event Coordination
            </li>
            <li className="flex items-center gap-2">
              <span className="text-orange-600 text-lg sm:text-xl">✔</span> Luxury Fleet Options
            </li>
          </ul>
          <motion.button
