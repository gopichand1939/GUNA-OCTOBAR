...
export default function ServiceHero() {
  ...
  return (
    <section
      className="relative overflow-hidden py-20 sm:py-24 md:py-32 text-center text-white bg-cover bg-center"
      style={{
        backgroundImage:
      ...
      >
        ...
        >
          <button
            ...
            className="px-6 sm:px-8 md:px-10 py-3 sm:py-3.5 md:py-4 bg-gradient-to-r from-orange-500 via-orange-600 to-blue-600 rounded-full text-white font-semibold text-sm sm:text-base md:text-lg shadow-lg hover:shadow-2xl active:scale-95 hover:scale-105 transition-all duration-500 touch-manipulation"
          >
            Discover More
          </button>
        </motion.div>
