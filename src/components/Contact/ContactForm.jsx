        ...
        >
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-5 bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl p-8 border border-blue-100">
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <button type="submit" className="w-full bg-gradient-to-r from-blue-700 to-blue-600 hover:to-blue-800 text-white py-3 rounded-lg font-semibold shadow-md transition">Send Message</button>
            </motion.div>
          </form>
        </motion.div>
        <motion.div
